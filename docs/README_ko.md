...
> 💡 **자동 감지 원리**: 활성화하면 AirText가 5개 언어 모두에 대해 병렬 음성 인식 엔진을 동시에 시작합니다. 처음 1~3초 동안 변환 품질을 분석하고 Apple NLLanguageRecognizer를 사용하여 최적의 매칭을 선택한 후, 감지된 언어로 원활하게 전환하여 인식을 계속합니다.
